      ...
      <section className="flex items-center justify-center py-16 md:py-24 px-4 text-center">
        <div className="max-w-5xl w-full bg-white rounded-3xl shadow-xl p-8 md:p-12 transform transition-transform duration-300 ease-in-out hover:scale-[1.01]">
          ...
          <h1 className="font-extrabold text-gray-900 text-4xl sm:text-5xl md:text-6xl tracking-tight leading-tight mb-6">
            Introducing Our College <br className="sm:hidden" /> Lost & Found
            Solution
          </h1>
          ...
          <p className="text-gray-600 text-lg sm:text-xl leading-relaxed mb-8 max-w-2xl mx-auto">
            Helping students and faculty easily track and recover lost items on
            campus. Our platform simplifies the process of reporting lost items
            and finding misplaced belongings, fostering a more connected and
            responsible college community.
          </p>
          {/* Call to action buttons */}
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button>
              <Link
                to="/report-lost" // This is the key! It tells React Router where to navigate.
                className="bg-indigo-600 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:bg-indigo-700 hover:shadow-xl transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-indigo-300 inline-block"
              >
                Report Lost Item
              </Link>
            </button>
            <button>
              <Link
                to="/list-items" // This is linking to the Items page
                className="bg-white text-indigo-600 border border-indigo-600 px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:bg-indigo-50 hover:shadow-xl transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-indigo-300"
              >
                Item List
              </Link>
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center p-6 bg-indigo-50 rounded-2xl shadow-md transform transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">
                Lost something? Quickly report it with details and photos. Found
                an item? Report it here too!
              </p>
            </div>
            {/* Step 2 */}
            <div className="flex flex-col items-center p-6 bg-blue-50 rounded-2xl shadow-md transform transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">
                Our system intelligently matches reported lost items with found
                items. Users can also browse.
              </p>
            </div>
            {/* Step 3 */}
            <div className="flex flex-col items-center p-6 bg-green-50 rounded-2xl shadow-md transform transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-600">
                Once a match is found, verify ownership and arrange for the safe
                return of the item.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-white rounded-2xl shadow-md text-left flex items-start space-x-4 transform transition-transform duration-300 hover:scale-105">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Simple forms to quickly report lost or found items with all
                  necessary details.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl shadow-md text-left flex items-start space-x-4 transform transition-transform duration-300 hover:scale-105">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Advanced algorithms to help you find your items faster by
                  suggesting matches.
                </p>
              </div>
            </div>
              ...
              <div className="flex-shrink-0 bg-yellow-100 p-3 rounded-full">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.592 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.592-1M12 12c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2"
                  ></path>
                </svg>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  Robust processes to ensure items are returned to their
                  rightful owners.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl shadow-md text-left flex items-start space-x-4 transform transition-transform duration-300 hover:scale-105">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Available to all students and staff, promoting a cohesive
                  community.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl shadow-md text-left flex items-start space-x-4 transform transition-transform duration-300 hover:scale-105">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get alerts when a potential match for your lost item is found.
                </p>
              </div>
            </div>
            {/* Feature 6 */}
            <div className="p-6 bg-white rounded-2xl shadow-md text-left flex items-start space-x-4 transform transition-transform duration-300 hover:scale-105">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Clean, intuitive design for easy navigation and a smooth user
                  experience.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 px-4 bg-indigo-700 text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-indigo-100 text-lg sm:text-xl leading-relaxed mb-8">
            Join our college community in making it easier to reunite lost items
            with their owners. Whether you've lost something or found an item,
