...
const FoundItemPage = () => {
    ...
    // 3. State for feedback messages
    const [message, setMessage] = useState({ type: '', text: '' });
    
    // 4. State for loading indicator
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage({ type: 'success', text: 'Found item reported successfully! Redirecting...' });
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-teal-50 p-4 sm:p-6 lg:p-8">
            <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 md:p-12 lg:p-16 w-full max-w-2xl flex flex-col items-center transform transition-transform duration-300 ease-in-out hover:scale-[1.01] border border-gray-200">
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-lg">
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            placeholder="e.g., set of keys, student ID card"
                            className="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
                            required
                        />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            rows="5" 
                            className="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-y transition-all duration-200"
                        ></textarea>
                    </div>

                    {/* Location Found */}
                    <div className="mb-6">
                        <label className="block text-gray-800 text-base font-semibold mb-2" htmlFor="locationFound">Location Found</label>
                        <input
                            type="text"
                            id="locationFound"
                            name="locationFound"
                    ...
                    <div className="mb-8">
                        ...
                        <input
                            ...
                            className="block w-full text-gray-800 text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100 transition-all duration-200 cursor-pointer"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-full focus:outline-none focus:shadow-outline shadow-md shadow-green-500/50 transform transition-all duration-300 ease-in-out hover:scale-105 disabled:bg-gray-400 disabled:shadow-none disabled:cursor-not-allowed"
                    >
                ...
                <div className="mt-8 text-center">
                    <Link
                        to="/" 
                        className="text-green-600 hover:text-green-800 text-base font-medium transition-colors duration-200"
                    >
                        ← Back to Home
                    </Link>
                </div>
